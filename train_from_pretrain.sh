...
python train.py --load_model /home/rwkv/RWKV-TS/RWKV-x060-World-1B6-v2.1-20240328-ctx4096.pth \
    --wandb "" --proj_dir out/dummy \
    --data_file /home/rwkv/RWKV-TS/RWKV_TS_FV-demo/RWKV_TS_FV-main/TEST_DATA_FV-100.xlsx \
    --data_type "json" --vocab_size 65536 \
    --ctx_len 24 --epoch_steps 100 --epoch_count 2 --epoch_begin 0 --epoch_save 0 \
